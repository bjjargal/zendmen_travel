<template>
    <a-page-header class="!p-0 !mb-2" title="Lead">
        <template #extra>
            <a-button @click="leads.reload()" :loading="leads.list.loading" class="!flex justify-center items-center">
                <template #icon>
    ...
    <a-table :columns="columns" :data-source="leads.data" size="small" :loading="leads.list.loading" :pagination="false"
        row-key="name" :scroll="{ y: 'calc(100vh - 280px)' }" :customRow="onRow">
    </a-table>
